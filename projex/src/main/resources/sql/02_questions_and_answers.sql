...
(1, 'FINANCEIRO', 'Qual o principal objetivo do fluxo de caixa?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(2, 'CONTABIL', 'O que caracteriza um ativo no balanço patrimonial?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(3, 'JURIDICO', 'Qual a finalidade de um contrato social?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(4, 'COMPRAS', 'O que é a cotação de preços no processo de compras?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(5, 'ADMINISTRATIVO', 'Qual das opções descreve a função do organograma?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(6, 'RH', 'Qual a principal função do processo de recrutamento?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(7, 'DEPARTAMENTO_PESSOAL', 'O que representa a folha de pagamento?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(8, 'TREINAMENTO', 'Qual o objetivo do processo de onboarding?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(9, 'HARDWARE', 'O que é a memória RAM de um computador?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(10, 'SOFTWARE', 'O que é um sistema operacional?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(11, 'INFRAESTRUTURA', 'Para que serve um servidor de banco de dados?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(12, 'REDES', 'Qual a função do protocolo IP em redes de computadores?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(13, 'SEGURANCA_DA_INFORMACAO', 'O que é a autenticação em dois fatores (2FA)?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(14, 'SUPORTE_TI', 'O que é um sistema de chamados (SLA/Ticketing)?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(15, 'DESENVOLVIMENTO', 'O que é um controle de versão como o Git?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(16, 'MARKETING', 'O que define o conceito de público-alvo?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(17, 'DESIGN', 'O que é a paleta de cores primária de uma marca?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(18, 'UX_UI', 'Qual é o foco do design de Usabilidade (UX)?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(19, 'MIDIAS_SOCIAIS', 'O que é o engajamento nas redes sociais?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(20, 'COMERCIAL', 'O que significa o funil de vendas?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(21, 'VENDAS', 'O que é a abordagem de venda consultiva?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(22, 'POS_VENDA', 'Qual a importância da pesquisa de satisfação (NPS)?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(23, 'ATENDIMENTO_CLIENTE', 'O que é o tempo médio de atendimento (TMA)?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(24, 'LOGISTICA', 'O que é o controle de estoque FIFO/PEPS?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL),
(25, 'OPERACIONAL', 'Para que serve o mapeamento de processos?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'FACIL', NULL),
(26, 'MANUTENCAO', 'O que difere manutenção preventiva de corretiva?', 'MULTIPLA_ESCOLHA', 10, 1, TRUE, 'MEDIO', NULL);
